  ...
  window.CKEDITOR && window.CKEDITOR.dom || (window.CKEDITOR || (window.CKEDITOR = function() {
          ...
          fire: function() {
            ...
            return function(d, h, l) {
              ...
              if (g) {
                var p = g.listeners;
                if (p.length)
                  for (var p = p.slice(0), u, C = 0; C < p.length; C++) {
                    if (g.errorProof) try {
                      u = p[C].call(this,
                        l, h, b, k)
                    } catch (w) {}
    ...
    function() {
      ...
      CKEDITOR.tools = {
        ...
        getMouseButton: function(a) {
          var g = (a = a.data) && a.$;
          return a && g ? CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? 4 ===
            g.button ? CKEDITOR.MOUSE_BUTTON_MIDDLE : 1 === g.button ? CKEDITOR.MOUSE_BUTTON_LEFT : CKEDITOR.MOUSE_BUTTON_RIGHT : g.button : !1
        },
        style: {
          parse: {
            _colors: {
            ...
            background: function(a) {
              ...
              if (a = CKEDITOR.tools.trim(a)) g.unprocessed =
                a;
              return g
            },
            margin: function(a) {
    ...
    4456448, CKEDITOR.EVENT_PHASE_CAPTURING = 1, CKEDITOR.EVENT_PHASE_AT_TARGET = 2, CKEDITOR.EVENT_PHASE_BUBBLING = 3, CKEDITOR.dom.domObject = function(a) {
      ...
      return {
        ...
        on: function(f) {
          ...
          b || (b = {}, this.setCustomData("_cke_nativeListeners",
            b));
        ...
        removeListener: function(a) {
          ...
          if (!this.hasListeners(a)) {
            var b = this.getCustomData("_cke_nativeListeners"),
              c = b && b[a];
            c && (this.$.removeEventListener ? this.$.removeEventListener(a, c, !1) : this.$.detachEvent && this.$.detachEvent("on" +
              a, c), delete b[a])
          }
        },
        removeAllListeners: function() {
    ...
    0, CKEDITOR.POSITION_DISCONNECTED = 1, CKEDITOR.POSITION_FOLLOWING = 2, CKEDITOR.POSITION_PRECEDING = 4, CKEDITOR.POSITION_IS_CONTAINED = 8, CKEDITOR.POSITION_CONTAINS = 16, CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
      ...
      getPosition: function(a) {
        ...
        if (this.type == CKEDITOR.NODE_ELEMENT && a.type == CKEDITOR.NODE_ELEMENT) {
          ...
          if ("sourceIndex" in f) return 0 > f.sourceIndex || 0 > b.sourceIndex ? CKEDITOR.POSITION_DISCONNECTED : f.sourceIndex < b.sourceIndex ? CKEDITOR.POSITION_PRECEDING :
      ...
      getViewPaneSize: function() {
        ...
        return {
          ...
          height: (f ? a.documentElement.clientHeight :
      ...
      getByAddress: function(a, f) {
        for (var b = this.$.documentElement, c = 0; b &&
          c < a.length; c++) {
          var e = a[c];
          if (f)
            for (var m = -1, k = 0; k < b.childNodes.length; k++) {
      ...
      getHead: function() {
        ...
        return a = a ? new CKEDITOR.dom.element(a) :
      ...
      CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
        ...
        breakParent: function(a, b) {
          ...
          if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
            for (c =
              new CKEDITOR.dom.element("div"); e = g.getFirst();) e.$.style.backgroundColor && (e.$.style.backgroundColor = e.$.style.backgroundColor), c.append(e);
            c.insertAfter(this);
            c.remove(!0)
        ...
        getDocumentPosition: function(a) {
          ...
          if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
            ...
            for (w = this, q = null; w && "body" != w.getName() &&
              "html" != w.getName();) {
        ...
        copyAttributes: function(a, b) {
          ...
          for (var g = 0; g < c.length; g++) {
            var e = c[g],
              ...
              m;
            if (!(f in b))
              if ("checked" == f && (m = this.getAttribute(f))) a.setAttribute(f, m);
              else if (!CKEDITOR.env.ie || this.hasAttribute(f)) m = this.getAttribute(f), null === m && (m = e.nodeValue), a.setAttribute(f, m)
          }
          "" !== this.$.style.cssText &&
    ...
    function() {
      function a(a, b) {
        ...
        this.current ? c = this.current[m](!1,
          n, l) : (a ? c.type == CKEDITOR.NODE_ELEMENT && (c = 0 < f ? c.getChild(f - 1) : !1 === l(c, !0) ? null : c.getPreviousSourceNode(!0, n, l)) : (c = d, c.type == CKEDITOR.NODE_ELEMENT && ((c = c.getChild(e)) || (c = !1 === l(d, !0) ? null : d.getNextSourceNode(!0, n, l)))), c && !1 === l(c) && (c = null));
        for (; c && !this._.end;) {
          this.current = c;
    ...
    function() {
      ...
      function f(a, b, c, d, e) {
        ...
        var y = a.startContainer,
          ...
          B = a.endOffset,
          H, G, E, I, F, K;
        if (t && v.type == CKEDITOR.NODE_TEXT && (y.equals(v) || y.type === CKEDITOR.NODE_ELEMENT && y.getFirst().equals(v))) c.append(a.document.createText(v.substring(z, B)));
        else {
          ...
          y.type ==
            CKEDITOR.NODE_TEXT ? t ? F = !0 : y.split(z) : 0 < y.getChildCount() ? 0 === z ? (y = y.getChild(z), H = !0) : y = y.getChild(z - 1) : E = H = !0;
          ...
          L = c;
          for (O = Q; O <= R; O++)
            if (c = D[O], ba = c.getPrevious(), c.equals(J[O])) b && (L = L.getChild(0));
            else {
      ...
      CKEDITOR.dom.range.prototype = {
        ...
        enlarge: function(a, b) {
          ...
          switch (a) {
            ...
            case CKEDITOR.ENLARGE_ELEMENT:
              ...
              B.type == CKEDITOR.NODE_TEXT ? (G && (B = !CKEDITOR.tools.trim(B.substring(0, G)).length &&
                B, z = !!B), B && ((y = B.getPrevious()) || (t = B.getParent()))) : (G && (y = B.getChild(G - 1) || B.getLast()), y || (t = B));
              for (t = c(t); t || y;) {
                if (t && !y) {
                  !v && t.equals(l) && (v = !0);
                ...
                for (; y;)
                  if (B = !1, y.type == CKEDITOR.NODE_COMMENT) y = y.getPrevious();
                  else {
                    if (y.type == CKEDITOR.NODE_TEXT) H = y.getText(), d.test(H) && (y = null), B = /[\s\ufeff]$/.test(H);
                    else if ((y.$.offsetWidth > (CKEDITOR.env.webkit ? 1 :
                        0) || b && y.is("br")) && !y.data("cke-bookmark"))
                      if (z && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        H = y.getText();
                        if (d.test(H)) y = null;
                        else
                          for (var G = y.$.getElementsByTagName("*"), E = 0, I; I = G[E++];)
              ...
              B.type == CKEDITOR.NODE_TEXT ?
                CKEDITOR.tools.trim(B.substring(G)).length ? z = !0 : (z = !B.getLength(), G == B.getLength() ? (y = B.getNext()) || (t = B.getParent()) : f(B, G) && (t = B.getParent())) : (y = B.getChild(G)) || (t = B);
              for (; t || y;) {
                if (t && !y) {
                  !v && t.equals(l) && (v = !0);
                  if (e ? t.isBlockBoundary() : !h.contains(t)) break;
                ...
                for (; y;) {
                  B = !1;
                  if (y.type == CKEDITOR.NODE_TEXT) H = y.getText(), f(y, 0) || (y = null), B = /^[\s\ufeff]/.test(H);
                    ...
                    if ((0 < y.$.offsetWidth ||
                      ...
                      if (z && CKEDITOR.dtd.$removeEmpty[y.getName()]) {
                        ...
                        if (d.test(H)) y = null;
                          ...
                          for (G = y.$.getElementsByTagName("*"), E = 0; I = G[E++];)
                            if (!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]) {
                              y = null;
                              break
                            }
            ...
            case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
              ...
              var F, K, J = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {
                  br: 1
                } : null),
                D = null,
                Q = function(a) {
        ...
        shrink: function(a, b, c) {
          ...
          if (!this.collapsed) {
            ...
            t && (f.reset(), (f = f[a == CKEDITOR.SHRINK_ELEMENT ?
        ...
        splitBlock: function(a, b) {
          ...
          this.deleteContents();
          e && e.equals(f) && (d ? (l = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(f, CKEDITOR.POSITION_AFTER_END), f = null) : c ? (l = new CKEDITOR.dom.elementPath(this.startContainer, this.root), this.moveToPosition(e,
        ...
        moveToClosestEditablePosition: function(a, b) {
          ...
          a ? (c = new CKEDITOR.dom.range(this.root),
            c.moveToPosition(a, l[b ? 0 : 1])) : c = this.clone();
        ...
        _find: function(a, b) {
          ...
          if (c && c.find)
            for (l = c.find(a), f = 0; f < l.count(); f++)
              if (c = l.getItem(f), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING ||
                d.startNode.equals(c), m = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED || d.endNode.equals(c), h && m && e.push(c);
          return e
        }
      };
      ...
      a.prototype = {
        getNextParagraph: function(a) {
          ...
          if (!this._.started) {
            ...
            w.collapsed || (f = new CKEDITOR.dom.walker(w.clone()),
              q = CKEDITOR.dom.walker.bookmark(!0, !0), f.evaluator = q, this._.nextNode = f.next(), f = new CKEDITOR.dom.walker(w.clone()), f.evaluator = q, f = f.previous(), this._.lastNode = f.getNextSourceNode(!0, null, w.root), this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary() && (q = this.range.clone(), q.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END), q.checkEndOfBlock() && (q = new CKEDITOR.dom.elementPath(q.endContainer,
                q.root), this._.lastNode = (q.block || q.blockLimit).getNextSourceNode(!0))), this._.lastNode && w.root.contains(this._.lastNode) || (this._.lastNode = this._.docEndMarker = w.document.createText(""), this._.lastNode.insertAfter(f)), w = null);
            this._.started = 1;
            f = w
          }
          q = this._.nextNode;
          ...
          if (!g) {
            ...
            g = g.block;
            !g && q && !this.enforceRealBlocks && x[q.getName()] &&
    ...
    function() {
      function a(a, b, c, d, e) {
        ...
        for (d = a.length; c < d; ++c) {
          ...
          for (m in J) {
            ...
            y = [];
            D = void 0;
            for (D in t) - 1 < D.indexOf("*") ? y.push(new RegExp("^" +
              D.replace(/\*/g, ".*") + "$")) : y.push(D);
            t = y;
            t.length && (h[l] = t, q = !1)
          }
          h.nothingRequired = q;
          ...
          if (!0 === g.elements || null === g.elements) e[f ? "unshift" : "push"](g);
            ...
            for (r in h = g.elements, delete g.elements, h)
              if (b[r]) b[r][f ? "unshift" : "push"](g);
              else b[r] = [g]
        }
      }
      ...
      function f(a, c, e, g) {
        if (!a.match || a.match(c))
          if (g || d(a, c))
            if (a.propertiesOnly || (e.valid = !0), e.allAttributes || (e.allAttributes = b(a.attributes, c.attributes, e.validAttributes)), e.allStyles || (e.allStyles = b(a.styles,
        ...
        if (e.doFilter) {
          a: {
            ...
            if (a || h) {
              ...
              if (m)
                for (D = 0, v = m.length; D < v; ++D) c(m[D], b, t);
              if (a)
                for (D = 0, v = a.length; D < v; ++D) f(a[D], b, t, k);
              if (h)
                for (D =
                  0, v = h.length; D < v; ++D) f(h[D], b, t, k);
              a = t
            } else a = null
          }
          if (!a || !a.valid) return d.push(b), 1;v = a.validAttributes;
          var J = a.validStyles;h = a.validClasses;
          var l = b.attributes,
            H = b.styles,
            m = b.classes;k = b.classBackup;
          var n = b.styleBackup,
            x, r, z = [],
            t = [],
            E = /^data-cke-/;D = !1;delete l.style;delete l["class"];delete b.classBackup;delete b.styleBackup;
          if (!a.allAttributes)
            for (x in l) v[x] || (E.test(x) ? x == (r = x.replace(/^data-cke-saved-/, "")) || v[r] || (delete l[x], D = !0) : (delete l[x], D = !0));
          if (!a.allStyles || a.hadInvalidStyle) {
            for (x in H) a.allStyles ||
              J[x] ? z.push(x + ":" + H[x]) : D = !0;
          ...
          if ("br" == b) a.previous && !A(a.previous) && (b = r(), b.insertBefore(a)), a.next && !A(a.next) && (b = r(), b.insertAfter(a)), a.replaceWithChildren();
            ...
            b: {
              ...
              for (var g = 0, f = d.length, h; g < f; ++g)
                if (h = d[g], h.type == CKEDITOR.NODE_ELEMENT &&
                  !e[h.name]) {
                  e = !1;
                  break b
                }
            ...
            if (e) a.name = b, a.attributes = {}, c.push({
              ...
              for (var g = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, l, m, f = d.length; 0 < f;) h = d[--f], g && (h.type == CKEDITOR.NODE_TEXT || h.type == CKEDITOR.NODE_ELEMENT && G.$inline[h.name]) ? (l || (l = new CKEDITOR.htmlParser.element(b), l.insertAfter(a), c.push({
                check: "parent-down",
                el: l
              })), l.add(h, 0)) : (l = null, m = G[e.name] || G.span, h.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || h.type != CKEDITOR.NODE_ELEMENT ||
                m[h.name] || c.push({
                  check: "el-up",
                  el: h
                }));
      ...
      function v(a, b) {
        ...
        for (g in d)
          if ("class" == g)
            for (c = d[g].split(/\s+/), h = a.classes.join("|"); l = c.pop();) {
      ...
      CKEDITOR.filter = function(a) {
        ...
        if (a instanceof CKEDITOR.editor) {
          ...
          !0 === b ? this.disabled = !0 : (b , this.allow(b, "config", 1), this.allow(a.config.extraAllowedContent, "extra",
            1), this.allow(F[a.enterMode] + " " + F[a.shiftEnterMode], "default", 1), this.disallow(a.config.disallowedContent))
        }
      };
      ...
      CKEDITOR.filter.prototype = {
        allow: function(b, c, d) {
          ...
          if ("string" == typeof b) b = g(b);
            ...
            b[e.element] = e = {
              styles: e.styles,
              requiredStyles: e.styles &&
                CKEDITOR.tools.objectKeys(e.styles)
            };
        ...
        applyTo: function(a, b, c, d) {
          ...
          a.forEach(function(a) {
            if (a.type == CKEDITOR.NODE_ELEMENT) {
              ...
              a: {
                ...
                d = CKEDITOR.htmlParser.fragment.fromHtml(d);1 == d.children.length && (q = d.children[0]).type == CKEDITOR.NODE_ELEMENT && u(e, q, c, m);c = !c.length
              }
              c || g.push(a)
            }
          }, null, !0);
          ...
          for (; k = a.pop();)
            if (c = k.el, c.parent) switch (y = G[c.parent.name] || G.span, k.check) {
              case "it":
                G.$removeEmpty[c.name] && !c.children.length ? t(c, d, a) : q(c) ||
                  t(c, d, a);
                break;
              case "el-up":
        ...
        addFeature: function(a) {
          ...
          return a.requiredContent && ( this.disallowedContent.length) ? this.check(a.requiredContent) : !0
        },
      ...
      L = CKEDITOR.filter.transformationsTools = {
        ...
        transform: function(a, b) {
          if ("string" == typeof b) a.name = b;
            ...
            for (g in e)
              if ("class" == g)
                for (c = a.classes.join("|"), h = e[g].split(/\s+/); l = h.pop();) - 1 == c.indexOf(l) && a.classes.push(l);
              else a.attributes[g] = e[g];
            for (f in d) a.styles[f] =
              d[f]
          }
        }
      }
    ...
    function() {
      ...
      getPath: function(a) {
        ...
        return CKEDITOR.getUrl(f && f.dir || this.basePath +
          a + "/")
      },
          ...
          k = function(b) {
            a.call(this, b, function(a) {
              ...
              for (d in a) {
                ...
                if (!f[d]) {
                  if (n.icons)
                    for (var u = n.icons.split(","), C = u.length; C--;) CKEDITOR.skin.addIcon(u[C], n.path + "icons/" + (CKEDITOR.env.hidpi && n.hidpi ? "hidpi/" : "") + u[C] + ".png");
                  f[d] = 1
                }
                if (p)
                  for (p.split && (p = p.split(",")), n = 0; n < p.length; n++) m[p[n]] || b.push(p[n])
              }
              if (b.length) k.call(this, b);
              else {
                for (d in m) n = m[d], n.onLoad && !n.onLoad._called && (!1 === n.onLoad() && delete m[d],
                  n.onLoad._called = 1);
                c && c.call(e || window, m)
              }
            }, this)
      ...
      function n(a) {
        ...
        CKEDITOR.plugins.load(c.split(","), function(c) {
          ...
          for (var h in c) {
            ...
            if (t && (y = t.match(f)))
              for (; t = y.pop();) CKEDITOR.error("editor-plugin-required", {
                plugin: t.replace(",", ""),
                requiredBy: h
              });
      ...
      CKEDITOR.htmlParser.prototype = {
        ...
        parse: function(b) {
          for (var c, e, m = 0, k; c = this._.htmlPartsRegex.exec(b);) {
            e = c.index;
            if (e > m)
              if (m = b.substring(m, e), k) k.push(m);
              else this.onText(m);
    ...
    function() {
      ...
      CKEDITOR.htmlParser.fragment.fromHtml = function(m, k, d) {
            ...
            if (a(e)) q.push(e);
              ...
              if ("br" == d) x.push(e);
                ...
                for (; !(m = (g = r.name) ? CKEDITOR.dtd[g] || (r._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, e.isUnknown || r.isUnknown || m[d]);)
                  if (r.isOptionalClose) C.onTagClose(g);
                  else if (d in b && g in b) g = r.children, (g = g[g.length - 1]) && "li" == g.name || n(g = new CKEDITOR.htmlParser.element("li"),
                  r), !e.returnPoint && (e.returnPoint = r), r = g;
                else if (d in CKEDITOR.dtd.$listItem && !u(d, g)) C.onTagOpen("li" == d ? "ul" : "dl", {}, 0, 1);
                else if (g in f && !u(d, g)) !e.returnPoint && (e.returnPoint = r), r = r.parent;
                else if (g in CKEDITOR.dtd.$inline && q.unshift(r), r.parent) n(r, r.parent, 1);
                else {
                  e.isOrphan = 1;
                  break
                }
        ...
        C.onTagClose = function(a) {
          ...
          for (var c = [], e = [], g = r; g != w && g.name != a;) g._.isBlockLike || e.unshift(g), c.push(g),
        ...
        C.onText = function(a) {
          ...
          if (!A && !g["#"] && b in f) C.onTagOpen(e[b] || ""), C.onText(a);
          else {
            l();
            h();
            t || A || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    function() {
      function a(a,
          ...
          return function(e) {
            if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              var f = [],
                ...
                k, t;
              if (l)
                for (h(l, 1) && f.push(l); l;) m(l) && (k = c(l)) && h(k) && ((t = c(k)) && !m(t) ? f.push(k) : (g(D).insertAfter(k), k.remove())), l = l.previous;
              for (l = 0; l < f.length; l++) f[l].remove();
              if (f = !a || !1 !== ("function" == typeof d ? d(e) : d)) D || CKEDITOR.env.needsBrFiller || e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT ?
                D || CKEDITOR.env.needsBrFiller || !(7 < document.documentMode || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem) ? (f = b(e), f = !f || "form" == e.name && "input" == f.name) : f = !1 : f = !1;
              f && e.add(g(a))
            }
          }
        }
        ...
        function h(a, b) {
          ...
          var c;
          return a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(q)) && (c.index && ((new CKEDITOR.htmlParser.text(a.value.substring(0, c.index))).insertBefore(a), a.value = c[0]), !CKEDITOR.env.needsBrFiller &&
            D && (!b || a.parent.name in J) || !D && ((c = a.previous) && "br" == c.name || !c || m(c))) ? !0 : !1
        }
        var l = {
            elements: {}
          },
          ...
          return function(b) {
            if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
              ...
              if ("data-cke-bogus" in d || "data-cke-eol" in d) delete d["data-cke-bogus"];
                ...
                var f = c(b);
                !d && m(b.parent) ? k(b.parent,
                  g(a)) : m(d) && f && !m(f) && g(a).insertBefore(d)
              }
            }
          }
        }(D);
      ...
      var q = /(?:&nbsp;|\xa0)$/,
        ...
        t = CKEDITOR.tools.extend({}, r.$blockLimit,
          r.$block),
        y = {
          elements: {
            input: d,
    ...
    function() {
      ...
      CKEDITOR.inlineAll = function() {
        ...
        for (b in CKEDITOR.dtd.$editable)
          for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, m = c.count(); e < m; e++) a = c.getItem(e), "true" == a.getAttribute("contenteditable") && (f = {
            element: a,
            config: {}
    ...
    function() {
      function a(a) {
        ...
        if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)
          if (g = f(g, d)) g.appendBogus(), l = CKEDITOR.env.ie;
        k(b, d.block, e) && h.collapsed && !h.getCommonAncestor().isReadOnly() && (d = h.clone(), d.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), e = new CKEDITOR.dom.walker(d), e.guard = function(a) {
          ...
          (b = b.getFirst(c)) && b.type == CKEDITOR.NODE_TEXT && CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/) && b.remove(), l = 1, a.cancel());
        l && h.select()
      }
      ...
      w = function() {
        ...
        function b(c, d) {
          ...
          e = d.range.startPath();
          for (var k = m[k.getName()], n = 0, q = c.getChildren(), H = q.count(), x = -1, v = -1, r = 0, p = e.contains(m.$list); n < H; ++n) e = q.getItem(n), a(e) ? (f = e.getName(), p && f in CKEDITOR.dtd.$list ? l = l.concat(b(e, d)) : (h = !!k[f],
            "br" != f || !e.data("cke-eol") || n && n != H - 1 || (r = (g = n ? l[n - 1].node : q.getItem(n + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != x || h || (x = n), h || (v = n), l.push({

            }), g = r = 0)) : l.push({
            isElement: 0,
            node: e,
            allowed: 1
          }); - 1 < x && (l[x].firstNotAllowed = 1); - 1 < v && (l[v].lastNotAllowed = 1);
          return l
        }
        ...
        function e(b, c) {
          ...
          for (n && d.push(" "); l < f; l++) h =
            g.getItem(l), a(h) && !h.is(k) ? d = d.concat(e(h, c)) : d.push(h);
          n && d.push(" ");
          return d
        }
        ...
        function h(b, c, d, e) {
          ...
          (f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && n[f.getName()] && (l = f.getPrevious()) && a(l) && !l.getParent().equals(b.startContainer) && d.contains(l) && e.contains(f) && f.isIdentical(l) &&
            (f.moveChildren(l), f.remove(), h(b, c, d, e))
        }
        ...
        return function(n, D, r, p) {
          ...
          if (!p.checkReadOnly()) {
            ...
            for (;
              (u = g(D)) && a(u) && u.isBlockBoundary() && w.contains(u);) D.moveToPosition(u, CKEDITOR.POSITION_BEFORE_END);
            h(D, n.blockLimit, w, C);
            I && (D.setEndBefore(I), D.collapse(), I.remove());
            I = D.startPath();
            if (A = I.contains(f, !1,
                1)) D.splitElement(A), n.inlineStylesRoot = A, n.inlineStylesPeak = I.lastElement;
            I = D.createBookmark();
            (A = I.startNode.getPrevious(c)) && a(A) && f(A) && p.push(A);
            (A = I.startNode.getNext(c)) && a(A) && f(A) && p.push(A);
            for (A = I.startNode;
              (A = A.getParent()) && f(A);) p.push(A);
            D.moveToBookmark(I);
            if (I = r) {
              I = n.range;
              ...
              if ((O = I.startPath().block) && (1 != O.getChildCount() || !O.getBogus())) a: {
                var P;
                if (1 ==
                  u.getChildCount() && a(P = u.getFirst()) && P.is(q) && !P.hasAttribute("contenteditable")) {
            ...
            if (I) {
              ...
              for (l(D, P); p < D.length; p++) {
                ...
                if (M) r = 0 < p;
                  ...
                  M = P.startPath();
                  !C.isBlock && k(n.editor, M.block, M.blockLimit) && (X = d(n.editor)) && (X = I.createElement(X), X.appendBogus(), P.insertNode(X),
                  ...
                  if (A && C.isElement) {
                    ...
                    if (M) V && (Y = P.splitElement(V), n.zombies.push(Y), n.zombies.push(V));
                    else {
                      V = u.getName();
                      Z = !p;
                      M = p == D.length - 1;
              ...
              T && (r = !0, M = D[0].node, P.setStartAt(M, CKEDITOR.POSITION_BEFORE_START), P.setEndAt(M,
      ...
      q = function() {
        ...
        return function(d) {
          ...
          g || (g = e);
          g.is("table") ? (d.setStartAt(g,
            CKEDITOR.POSITION_BEFORE_START), d.collapse(!0), g.remove()) : (g.is({
            tbody: 1,
            thead: 1,
            tfoot: 1
          ...
          table: function() {
            function a(c) {
              ...
              f.guard = function(a, f) {
                ...
                else if (!f && l && a.equals(l)) g = c.clone(), g.setStartAt(l, CKEDITOR.POSITION_AFTER_START), e.push(g);
                else {
            ...
            return {
              ...
              detectRanges: function(e, g) {
                ...
                m = m.contains("table");
                k = k.contains("table");
                if (m || k) m && k && b(m, k) ? (e.tableSurroundingRange = h, h.setStartAt(m, CKEDITOR.POSITION_AFTER_END), h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), h = f.clone(), h.setEndAt(m, CKEDITOR.POSITION_AFTER_END), l = f.clone(), l.setStartAt(k, CKEDITOR.POSITION_BEFORE_START), l = a(h).concat(a(l))) : m ? k || (e.tableSurroundingRange = h, h.setStartAt(m, CKEDITOR.POSITION_AFTER_END), f.setEndAt(m,
                  CKEDITOR.POSITION_AFTER_END)) : (e.tableSurroundingRange = h, h.setEndAt(k, CKEDITOR.POSITION_BEFORE_START), f.setStartAt(k, CKEDITOR.POSITION_AFTER_START)), e.tableContentsRanges = l ? l : a(f)
              },
    ...
    function() {
      ...
      function m() {
        y = !0;
        t || (k.call(this), t = CKEDITOR.tools.setTimeout(k,
          200, this))
      }
      ...
      function h(a) {
        ...
        return b(e) || b(g, 1) || !(e || g || c.type == CKEDITOR.NODE_ELEMENT && c.isBlockBoundary() &&
          c.getBogus()) ? !0 : !1
      }
        ...
        if (c) {
          if (!1 !== b) {
            ...
            if (c.getLength() > g && e && e.intersectsNode(c.$)) {
              ...
              d.focusNode ==
                c.$ && d.focusOffset > g && (f[1].offset -= g)
            }
          }
        ...
        for (var b = 0; b < a.length; b++) {
          ...
          if (!c.collapsed) {
            if (c.startContainer.isReadOnly())
              for (var d = c.startContainer, e; d && !((e = d.type == CKEDITOR.NODE_ELEMENT) &&
      ...
      var w = "function" != typeof window.getSelection,
        ...
        r = new RegExp(x + "( )?", "g"),
        A, t, y, v = CKEDITOR.dom.walker.invisible(1),
        z = function() {
          function a(b) {
            return function(a) {
      ...
      CKEDITOR.on("instanceCreated", function(a) {
        ...
        c.on("contentDom", function() {
          ...
          function d(a) {
            if (CKEDITOR.env.ie) {
              var b = (a = a.getRanges()[0]) ? a.startContainer.getAscendant(function(a) {
                return a.type == CKEDITOR.NODE_ELEMENT && ("false" == a.getAttribute("contenteditable") || "true" ==
          ...
          l.attachListener(l, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function() {
            x &&
              CKEDITOR.env.webkit && (x = c._.previousActive && c._.previousActive.equals(f.getActive())) && null != c._.previousScrollTop && c._.previousScrollTop != l.$.scrollTop && (l.$.scrollTop = c._.previousScrollTop);
            c.unlockSelection(x);
            x = 0
          }, null, null, -1);
      ...
      if (CKEDITOR.env.webkit) CKEDITOR.on("instanceReady", function(a) {
        ...
        b.on("selectionChange", function() {
          ...
          c && (c.getCustomData("ready") ?
            (g(a), a.editor.fire("selectionCheck")) : c.setCustomData("ready", 1))
        }, null, null, -1);
        ...
        getRanges: function() {
          var a = w ? function() {
            ...
            var b = function(b, c) {
              ...
              for (var e = d.children, g, f, h = b.duplicate(), l = 0, k = e.length - 1, m = -1, n, q; l <= k;)
                if (m = Math.floor((l + k) / 2), g = e[m], h.moveToElementText(g), n = h.compareEndPoints("StartToStart", b), 0 < n) k = m - 1;
                else if (0 > n) l = m + 1;
              else return {
                container: d,
                offset: a(g)
        ...
        unlock: function(b) {
          if (this.isLocked) {
            ...
            b && (b = d || e[0] && e[0].getCommonAncestor()) && b.getAscendant("body",
              1) && (a(e) ? c.call(this, e) : g ? this.fake(d) : d ? this.selectElement(d) : this.selectRanges(e))
          }
        },
        reset: function() {
          this._.cache = {};
          ...
          if (b.length)
            if (this.isLocked) {
              ...
              a: {
                var D, q;
                if (1 == b.length &&
                  !(q = b[0]).collapsed && (n = q.getEnclosedNode()) && n.type == CKEDITOR.NODE_ELEMENT && (q = q.clone(), q.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (D = q.getEnclosedNode()) && D.type == CKEDITOR.NODE_ELEMENT && (n = D), "false" == n.getAttribute("contenteditable"))) break a;n = void 0
              }
              if (n) this.fake(n);
                ...
                if (w) {
                  ...
                  for (p = 0; p < b.length; p++) {
                    if (p < b.length - 1 && (x = b[p], r = b[p + 1], n = x.clone(), n.setStart(x.endContainer, x.endOffset), n.setEnd(r.startContainer, r.startOffset), !n.collapsed && (n.shrink(CKEDITOR.NODE_ELEMENT, !0), d = n.getCommonAncestor(), n = n.getEnclosedNode(),
                        d.isReadOnly() || n && n.isReadOnly()))) {
                    ...
                    try {
                      ...
                      if (0 <=
                        y.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), r.setEnd(d.endContainer.$, d.endOffset);
                      else throw y;
                    }
                    m.addRange(r)
                  }
    ...
    function() {
      ...
      function b(c) {
        var d = c.document;
        if (c.collapsed) d = x(this, d), c.insertNode(d), c.moveToPosition(d, CKEDITOR.POSITION_BEFORE_END);
        else {
          var g = this.element,
            h = this._.definition,
          ...
          for (v.getPosition(p) == CKEDITOR.POSITION_FOLLOWING && (v = 0); v;) {
            ...
            if (v.equals(p)) v = null, k = !0;
              ...
              if (t && m && CKEDITOR.dtd.$block[A])
                for (var u = v, z = e(u), B = void 0, H = z.length, da = 0,
                    u = H && new CKEDITOR.dom.range(u.getDocument()); da < H; ++da) {
                  var B = z[da],
              ...
              if (z)
                if (B = v.getParent(), z = h, H = g, da = l, !B || !(B.getDtd() || CKEDITOR.dtd.span)[H] && !da || z.parentRule && !z.parentRule(B)) k = !0;
                else {
                  if (y || A && CKEDITOR.dtd.$removeEmpty[A] && (v.getPosition(p) | K) != K || (y = c.clone(), y.setStartBefore(v)), A = v.type, A == CKEDITOR.NODE_TEXT || t || A == CKEDITOR.NODE_ELEMENT && !v.getChildCount()) {
                    for (var A =
                        v, F;
                      (k = !A.getNext(I)) && (F = A.getParent(), n[F.getName()]) && f(F, r, h, J);) A = F;
                    y.setEndAfter(A)
                  }
                }
              else k = !0;
      ...
      function c(a) {
        function b() {
          for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(m.getParent()), e = null, g = null, f =
        ...
        if (a.collapsed) {
          for (var g = new CKEDITOR.dom.elementPath(d.getParent(), a.root), f, h = 0, l; h < g.elements.length &&
            (l = g.elements[h]) && l != g.block && l != g.blockLimit; h++)
      ...
      function h(a) {
        ...
        for (var d, e; d = c.getNextParagraph();) this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ?
          "p" : "div")) && d.copyAttributes(e), l(d, e)) : u.call(this, d));
        a.moveToBookmark(b)
      }
      ...
      function u(a, b) {
        ...
        w(a, e, B[a.getName()]);
        g && (this._.definition.alwaysRemoveElement ? q(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? q(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ?
          "p" : "div"))
      }
      ...
      function C(a) {
        ...
        for (var g in b)
          if (g != this.element)
            for (c = a.getElementsByTag(g), e = c.count() - 1; 0 <= e; e--) d = c.getItem(e), d.isReadOnly() || w(d, b[g])
      }
          ...
          if ("string" == typeof this.element ? d == this.element : d in this.element) {
            ...
            if (c._length) {
              for (var h in c)
                if ("_length" !=
                  h)
                  if (d = a.getAttribute(h) || "", "style" == h ? v(c[h], d) : c[h] == d) {
                    if (!b) return !0
                  } else if (b) return !1;
              if (b) return !0
            } else return !0
      ...
      getStylesSet: function(a) {
        if (this._.stylesDefinitions) a(this._.stylesDefinitions);
          ...
          if (!1 === b) a(null);
            ...
            var b = b.split(":"),
              c = b[0];
            CKEDITOR.stylesSet.addExternal(c, CKEDITOR.getUrl("config.js"), "");
    ...
    function() {
      ...
      contains: function(a, f, b) {
        ...
        a instanceof
        CKEDITOR.dom.element ? e = function(b) {
          return b.equals(a)
          ...
          return {
            getNextRange: function(k) {
              ...
              if (d && 1 < a.length) {
                ...
                for (d.moveToBookmark(e.shift()); l--;) h =
    ...
    function() {
      ...
      function g(a) {
        ...
        if (e != CKEDITOR.DIALOG_RESIZE_NONE) {
          var f = a.getParentEditor(),
            g, h, k, l, m, n, q = CKEDITOR.tools.addFunction(function(d) {
              m = a.getSize();
          ...
          a.on("load", function() {
            ...
            b = CKEDITOR.dom.element.createFromHtml('\x3cdiv class\x3d"cke_resizer' + b + " cke_resizer_" + f.lang.dir + '" title\x3d"' + CKEDITOR.tools.htmlEncode(f.lang.common.resize) +
              '" onmousedown\x3d"CKEDITOR.tools.callFunction(' + q + ', event )"\x3e' + ("ltr" == f.lang.dir ? "◢" : "◣") + "\x3c/div\x3e");
      ...
      CKEDITOR.dialog = function(b, d) {
        ...
        function n(c) {
          if (B == CKEDITOR.dialog._.currentTop) {
            var d = c.data.getKeystroke(),
              ...
              g = [37, 38, 39, 40];
            z = w = 0;
            if (9 == d || d == CKEDITOR.SHIFT + 9) k(d == CKEDITOR.SHIFT + 9 ? -1 : 1), z = 1;
            else if (d == CKEDITOR.ALT + 121 && !B._.tabBarMode && 1 < B.getPageCount()) B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1, z = 1;
            else if (-1 != CKEDITOR.tools.indexOf(g,
                d) && B._.tabBarMode) d = -1 != CKEDITOR.tools.indexOf([e ? 39 : 37, 38], d) ? a.call(B) : f.call(B), B.selectPage(d), B._.tabs[d][0].focus(), z = 1;
            else if (13 != d && 32 != d || !B._.tabBarMode)
              if (13 == d) d = c.data.getTarget(), d.is("a", "button", "select", "textarea") || d.is("input") && "button" == d.$.type || ((d = this.getButton("ok")) && CKEDITOR.tools.setTimeout(d.click, 0, d), z = 1), w = 1;
              ...
              this._.tabBarMode = !1, this._.currentFocusIndex = -1, k(1), z = 1;
            x(c)
          }
        }
        ...
        if (b._.removeDialogTabs && (p = b._.removeDialogTabs[d]))
          for (A = 0; A < p.length; A++) r.removeContents(p[A]);
        ...
        this.on("show", function() {
          ...
          b.config.dialog_startupFocusTab && a ? (B._.tabBarMode = !0, B._.tabs[B._.currentTabId][0].focus(), B._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = a ? -1 : this._.focusList.length - 1, r.onFocus ?
            (a = r.onFocus.call(this)) && a.focus() : k(1))
        ...
        for (A = 0; A < r.contents.length; A++)(p = r.contents[A]);
        ...
        CKEDITOR.dialog.validate = {
          functions: function() {
            ...
            return function() {
              ...
              for (f = 0; f < e.length; f++) g = d == CKEDITOR.VALIDATE_AND ? g &&
                e[f](b) : g || e[f](b);
              return g ? !0 : c
            }
          },
        ...
        exec: function(a) {
          ...
          if (e) {
            ...
            if (b == CKEDITOR.TRISTATE_OFF) {
              ...
              h = k[0].getParent();
              e = [];
              for (d = 0; d < k.length; d++) b =
                k[d], h = h.getCommonAncestor(b.getParent());
              for (b = {
                  table: 1,
                  tbody: 1,
                  tr: 1,
              ...
              for (e.insertBefore(k[0]); 0 < k.length;) b =
                k.shift(), e.append(b)
              ...
              b = [];
              k = [];
              for (h = {}; 0 < d.length;) l = d.shift(), e = l.getParent(), l.getPrevious() ? l.getNext() ? (l.breakParent(l.getParent()), k.push(l.getNext())) :
                l.remove().insertAfter(e) : l.remove().insertBefore(e), e.getCustomData("blockquote_processed") || (k.push(e), CKEDITOR.dom.element.setMarker(h, e, "blockquote_processed", !0)), b.push(l);
              CKEDITOR.dom.element.clearAllMarkers(h);
    ...
    ka.prototype = {
      ...
      update: function(a) {
        ...
        m && (b.removeClass(this._getClass()), b.removeAttribute("aria-label"),
          this.type = m, b.addClass(this._getClass()), b.setAttribute("aria-label", this.type), "progress" != this.type || e ? "progress" != this.type && e && e.remove() : (e = this._createProgressElement(), e.insertBefore(c)));
      ...
      _hideAfterTimeout: function() {
        ...
        else if ("info" == this.type || "success" == this.type) f = "number" == typeof this.editor.config.notification_duration ? this.editor.config.notification_duration :
          5E3;
    ...
    function() {
      ...
      CKEDITOR.ui.button.prototype = {
        render: function(a, e) {
          function m() {
            var b = a.mode;
            b && (b = this.modes[b] ? void 0 !== x[b] ? x[b] : CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED, b = a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED :
          ...
          var u = {
            ...
            w = CKEDITOR.tools.addFunction(function(a) {
              var b;
              u.onfocus &&
                (b = !1 !== u.onfocus(u, new CKEDITOR.dom.event(a)));
              return b
            }),
            q = 0;
          ...
          if (this.modes) {
            ...
            CKEDITOR.TRISTATE_ON ? "on" : l.state == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off");
        ...
        function b() {
          for (var g = c(), h = CKEDITOR.tools.clone(a.config.toolbarGroups) ||
            ...
            if ("/" != m) {
              ...
              var w, q = m.groups;
              if (q)
                for (var x = 0; x < q.length; x++) w = q[x], (w = g[w]) && d(m, w);
              (w = g[m.name]) && d(m, w)
            }
          }
          return h
            ...
            if (c.data.space == e.config.toolbarLocation) {
              ...
              for (var p = e.toolbox.toolbars, u = a(e), C = u.length, w = 0; w < C; w++) {
                var q, x = 0,
                  ...
                  y;
                if (A)
                  if (g && (l.push("\x3c/span\x3e"), m = g = 0), "/" === A) l.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');
                  else {
                    y = A.items || A;
                    for (var v = 0; v < y.length; v++) {
                      ...
                      if (z) {
                        ...
                        if (z.type == CKEDITOR.UI_SEPARATOR) m = g && z;
                        else {
                          B = !1 !== z.canGroup;
                          if (!x) {
                          ...
                          B ? g || (l.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'), g = 1) : g && (l.push("\x3c/span\x3e"),
                            g = 0);
                          m && (H(m), m = 0);
                          H(z)
                        }
              ...
              if (e.config.toolbarCanCollapse && e.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                ...
                l.push('" onclick\x3d"CKEDITOR.tools.callFunction(' + E + ')"\x3e', '\x3cspan class\x3d"cke_arrow"\x3e\x26#9650;\x3c/span\x3e',
                  "\x3c/a\x3e")
              }
              l.push("\x3c/span\x3e");
              c.data.html += l.join("")
    ...
    function() {
      ...
      function f(b) {
        function c() {
          ...
          "beforepaste" == B.mainPasteEvent && (a.on("paste", function(a) {
            ...
            h, null, null, 0), a.on("beforepaste", function(a) {
        ...
        function l() {
          if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
            var a = b.getSelection(),
              c, d, e;
            a.getType() == CKEDITOR.SELECTION_ELEMENT && (c = a.getSelectedElement()) && (d = a.getRanges()[0], e = b.document.createText(""), e.insertBefore(c),
              d.setStartBefore(e), d.setEndAfter(c), a.selectRanges([d]), setTimeout(function() {
        ...
        function m(a, c) {
          ...
          if (!d.getById("cke_pastebin")) {
            ...
            CKEDITOR.env.safari && q.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select",
              "text"));
            ...
            setTimeout(function() {
              CKEDITOR.env.webkit &&
                (CKEDITOR.document.getBody().$.scrollTop = x);
              h && h.removeListener();
        ...
        function y(c) {
          ...
          e && B.canClipboardApiBeTrusted(d.dataTransfer,
      ...
      CKEDITOR.plugins.add("clipboard", {
        ...
        init: function(a) {
          ...
          a.on("paste", function(b) {}, null, null, 1);
          ...
          a.on("paste", function(d) {}, null, null, 6);
          a.on("paste", function(b) {
            b = b.data;
      ...
      CKEDITOR.plugins.clipboard.dataTransfer =
        function(a, b) {
          ...
          b && (this.sourceEditor = b, this.setData("text/html", b.getSelectedHtml(1)), "Text" ==
            l || this.getData("text/plain") || this.setData("text/plain", b.getSelection().getSelectedText()))
        };
          ...
          showBlock: function(a, c, e, f, k, d) {
            ...
            CKEDITOR.tools.setTimeout(function() {
              var a = CKEDITOR.tools.bind(function() {
                ...
                c = a.top;
                b.height -
                  a.top < e && (x = c > e ? x - e : b.height > e ? x - a.bottom + b.height : x - a.top);
        ...
        proto: {
          ...
          show: function(b, c, d, e) {
            ...
            for (var u = g.elementPath(), u = ['\x3cdiv class\x3d"cke_menu' + (u && u.direction() != g.lang.dir ? " cke_mixed_dir_content" : "") + '" role\x3d"presentation"\x3e'], C = f.length, w = C && f[0].group, q = 0; q < C; q++) {
              var x = f[q];
              w != x.group && (u.push('\x3cdiv class\x3d"cke_menuseparator" role\x3d"separator"\x3e\x3c/div\x3e'),
                w = x.group);
              x.render(this, q, u)
            }
            u.push("\x3c/div\x3e");
        ...
        proto: {
          render: function(a, f, d) {
            var h = a.id + String(f),
              ...
              g = "",
              n = this.editor,
              p, u, C = l == CKEDITOR.TRISTATE_ON ? "on" : l == CKEDITOR.TRISTATE_DISABLED ? "disabled" : "off";
            this.role in {
              menuitemcheckbox: 1,
              menuitemradio: 1
            ...
            for (var f = new CKEDITOR.dom.walker(e), l; l = f.next();)
              if (l.type == CKEDITOR.NODE_ELEMENT)
                if (!l.equals(d) && l.getDirection()) e.setStartAfter(l),
                  ...
                  if (g)
                    for (var n = "ltr" == a.data.dir ? ["_rtl", ""] : ["", "_rtl"], p = 0; p < g.length; p++) l.hasClass(g[p] + n[0]) && (l.removeClass(g[p] + n[0]), l.addClass(g[p] + n[1]));
      ...
      CKEDITOR.plugins.indent.specificDefinition.prototype = {
        ...
        refreshJob: function(a, b, m) {
          ...
          a.activeFilter.checkFeature(this) ?
            b.state = b.refresh.call(this, a, m) : b.state = f;
          return b.state
        },
    ...
    function() {
      function a(a) {
        function c(f) {
          ...
          for (var A =
              e.isIndent ? 1 : -1, r = h[0], h = h[h.length - 1], t = CKEDITOR.plugins.list.listToArray(f, g), y = t[h.getCustomData("listarray_index")].indent, r = r.getCustomData("listarray_index"); r <= h.getCustomData("listarray_index"); r++)
            if (t[r].indent += A, 0 < A) {
              var v = t[r].parent;
          ...
          if (!e.isIndent) {
            ...
            if ((z = f.getParent()) && z.is("li"))
              for (var A = h.listNode.getChildren(), B = [], C, r = A.count() - 1; 0 <= r; r--)(C = A.getItem(r)) && C.is && C.is("li") && B.push(C)
          }
          h && h.listNode.replace(f);
          if (B && B.length)
            for (r = 0; r < B.length; r++) {
              for (C = f = B[r];
                (C = C.getNext()) && C.is && C.getName() in k;) CKEDITOR.env.needsNbspFiller && !f.getFirst(b) && f.append(m.document.createText(" ")), f.append(C);
              f.insertAfter(z)
            }
        ...
        for (var e = this, g = this.database, k = this.context, m, u = a.getSelection(), u = (u && u.getRanges()).createIterator(); m =
          ...
          C && m.startContainer.type == CKEDITOR.NODE_ELEMENT && m.startContainer.getName() in k && (w = new CKEDITOR.dom.walker(m),
            w.evaluator = f, m.startContainer = w.next());
    ...
    function() {
      function a(a, b, c) {
        function d(c) {
          if (!(!(l =
              k[c ? "getFirst" : "getLast"]()) || l.is && l.isBlockBoundary() || !(m = b.root[c ? "getPrevious" : "getNext"](CKEDITOR.dom.walker.invisible(!0))) || m.is && m.isBlockBoundary({
              br: 1
      ...
      function b(a, b, c, d) {
        for (var e,
            f; e = a[d ? "getLast" : "getFirst"](u);)(f = e.getDirection(1)) !== b.getDirection(1) && e.setAttribute("dir", f), e.remove(), c ? e[d ? "insertBefore" : "insertAfter"](c) : b.append(e, d)
      }
      ...
      CKEDITOR.plugins.list = {
          ...
          for (var g = 0, h = a.getChildCount(); g <
            ...
            if ("li" == k.$.nodeName.toLowerCase()) {
              ...
              for (var m = 0, n = k.getChildCount(), p; m < n; m++) p = k.getChild(m),
                p.type == CKEDITOR.NODE_ELEMENT && d[p.getName()] ? CKEDITOR.plugins.list.listToArray(p, b, c, e + 1, l.grandparent) : l.contents.push(p)
            }
          }
          return c
        },
        arrayToList: function(a, b, c, e, f) {
          ...
          for (var h, k = a[c].parent.getDocument(), m = new CKEDITOR.dom.documentFragment(k), n = null, z = c, B = Math.max(a[c].indent, 0), p = null, u, E, I = e == CKEDITOR.ENTER_P ? "p" : "div";;) {
            ...
            if (F.indent == B) {
              n && a[z].parent.getName() == n.getName() || (n = a[z].parent.clone(!1,
                1), f && n.setAttribute("dir", f), m.append(n));
              ...
              z++
            } else if (F.indent == Math.max(B, 0) + 1) F = a[z - 1].element.getDirection(1), z = CKEDITOR.plugins.list.arrayToList(a, null, z, e, F != u ? u : null), !p.getChildCount() && CKEDITOR.env.needsNbspFiller && 7 >= k.$.documentMode && p.append(k.createText(" ")), p.append(z.listNode), z = z.nextIndex;
            else if (-1 == F.indent && !c && h) {
              d[h.getName()] ? (p =
                F.element.clone(!1, !0), u != h.getDirection(1) && p.setAttribute("dir", u)) : p = new CKEDITOR.dom.documentFragment(k);
              var n = h.getDirection(1) != u,
                ...
                N, R = F.contents.length,
                L;
              for (h = 0; h < R; h++)
                if (N = F.contents[h], l(N) && 1 < R) Q ? L = N.clone(1, 1) : p.append(N.clone(1, 1));
              ...
              p.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT && z != a.length - 1 && (CKEDITOR.env.needsBrFiller && (u = p.getLast()) && u.type == CKEDITOR.NODE_ELEMENT &&
                u.is("br") && u.remove(), (u = p.getLast(g)) && u.type == CKEDITOR.NODE_ELEMENT && u.is(CKEDITOR.dtd.$block) || p.append(k.createElement("br")));
      ...
      f.prototype = {
        exec: function(b) {
          ...
          for (var e = f.createBookmarks(!0), k = [], m = {}, h = h.createIterator(), n = 0;
            ...
            l = l.createIterator();
            for (l.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF; v =
              l.getNextParagraph();)
              if (!v.getCustomData("list_block")) {
                ...
                B || (B = u, B.getCustomData("list_group_object_" + n) ? B.getCustomData("list_group_object_" +
                  n).contents.push(v) : (z = {
                  root: B,
                  contents: [v]
          ...
          for (G = []; 0 < k.length;)
            if (z = k.shift(), this.state == CKEDITOR.TRISTATE_OFF)
              if (d[z.root.getName()]) {
                ...
                for (var E = n.root.getDocument(),
                    I = void 0, F = void 0, v = 0; v < u.length; v++) {
            ...
            if ("wysiwyg" == a.mode && c in {
              ...
              if (h && h.collapsed) {
                ...
                if (t) {
                  ...
                  if (v.range.setEndAt(y, CKEDITOR.POSITION_BEFORE_END), t = (y = f.getLast(g)) && e(y) ? y : f, l = 0, (z = v.next()) && z.type == CKEDITOR.NODE_ELEMENT && z.getName() in
                    d && z.equals(y) ? (l = 1, z = v.next()) : h.checkBoundaryOfElement(t, CKEDITOR.END) && (l = 2), l && z) {
                    h = h.clone();
                  ...
                  CKEDITOR.POSITION_BEFORE_END), (z = v.next()) && z.type == CKEDITOR.NODE_ELEMENT && z.is(d) && (z = z.getFirst(g), l.block && h.checkStartOfBlock() && h.checkEndOfBlock() ? (l.block.remove(), h.moveToElementEditStart(z), h.select()) : k(z) ? (h.moveToElementEditStart(z), h.select()) : (h = h.clone(), h.moveToElementEditStart(z), m(a, c, h)), b.cancel());
                setTimeout(function() {
                  a.selectionChange(1)
                })
              }
          ...
          if (m = m || f(a)) {
            ...
            if (C && w) {
              if (x && (x.is("li") || x.getParent().is("li"))) {
                ...
                if (A.is("li")) p || t ? (p && t && m.remove(), x[t ? "insertAfter" : "insertBefore"](A)) : x.breakParent(A);
                else {
                  if (a)
                    if (q.block.is("li") ? (A =
                        u.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), z && A.setAttribute("dir", C), v && A.setAttribute("style", v), w && A.setAttribute("class", w), x.moveChildren(A)) : A = q.block, p || t) A[p ? "insertBefore" : "insertAfter"](m);
                    else x.breakParent(m), A.insertAfter(m);
                  else if (x.appendBogus(!0), p || t)
                    for (; u = x[p ? "getFirst" : "getLast"]();) u[p ? "insertBefore" : "insertAfter"](m);
                  else
                    for (x.breakParent(m); u = x.getLast();) u.insertAfter(m);
                  x.remove()
                }
                r.selectBookmarks(y);
                return
            ...
            if (C = m.splitBlock(r)) {
              ...
              q = C.wasStartOfBlock;
              a = C.wasEndOfBlock;
              x ? (y = x.getParent(), y.is("li") && (x.breakParent(y), x.move(x.getNext(), 1))) : d && (y = d.getParent()) && y.is("li") && (d.breakParent(y), y = d.getNext(), m.moveToElementEditStart(y),
              ...
              if (q || a) {
                ...
                if (u = C.elementPath)
                  for (p = 0, r = u.elements.length; p < r; p++) {
                    y = u.elements[p];
              ...
              }, (y = A.next()) && y.type == CKEDITOR.NODE_ELEMENT && y.is("ul", "ol") && (CKEDITOR.env.needsBrFiller ? u.createElement("br") :
                u.createText(" ")).insertBefore(y)), x && m.moveToElementEditStart(x);
              m.select();
              m.scrollIntoView()
            }
          }
        ...
        enterBr: function(a, b, c, e) {
          if (c = c || f(a)) {
            var k = c.document,
              ...
              q = w.block,
              x = q && w.block.getName();
            e || "li" != x ? (!e && m && h.test(x) ? (m = q.getDirection()) ? (k = k.createElement("div"), k.setAttribute("dir", m), k.insertAfter(q), c.setStart(k, 0)) : (k.createElement("br").insertAfter(q), CKEDITOR.env.gecko && k.createText("").insertAfter(q),
    ...
    function() {
      ...
      function m(a, d, g, k) {
        if (k && k.length)
          for (var p, u = k.length; u--;)
            if (p = k[u], "hbox" != p.type && "vbox" != p.type && "fieldset" != p.type || m(a, d, g, p.children), p.filebrowser)
      ...
      function a(a) {
        var e = a.config,
          ...
          k = function() {
            ...
            var m, l, w, q, x, r, A, t = e.floatSpaceDockedOffsetX || 0,
            ...
            return function(d) {
              if (l = a.editable()) {
                ...
                m ? (r + y <= q.top ? g("top") : r + y > x.height - q.bottom ? g("pin") : g("bottom"), d = x.width / 2, d = e.floatSpacePreferRight ? "right" : 0 < q.left && q.right < x.width && q.width > w.width ? "rtl" == e.contentsLangDirection ? "right" : "left" : d - q.left > q.right - d ? "left" : "right", w.width > x.width ? (d = "left", n = 0) : (n = "left" == d ? 0 < q.left ? q.left : 0 : q.right < x.width ? x.width - q.right : 0, n + w.width > x.width && (d = "left" == d ?
                  "right" : "left", n = 0)), h.setStyle(d, b(("pin" == m ? v : t) + n + ("pin" == m ? 0 : "left" == d ? A : -A)))) : (m = "pin", g("pin"), k(d))
              }
            }
          }();
        if (m) {
    ...
    function() {
      ...
      init: function(a) {
        if (!a.blockless) {
          for (var f =
              a.config, b = a.lang.format, c = f.format_tags.split(";"), e = {}, m = 0, k = [], d = 0; d < c.length; d++) {
            var h = c[d],
              l = new CKEDITOR.style(f["format_" + h]);
            if ( a.filter.check(l)) m++, e[h] = l, e[h]._.enterMode = a.config.enterMode, k.push(l)
          }
    ...
    function() {
      ...
      CKEDITOR.plugins.add("link", {
        ...
        init: function(a) {
          ...
          a.on("doubleclick", function(b) {
            ...
            c && !c.isReadOnly() && (c.is("a") ? (b.data.dialog = !c.getAttribute("name") || c.getAttribute("href") && c.getChildCount() ? "link" :
              "anchor", b.data.link = c) : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, c) && (b.data.dialog = "anchor"))
          }, null, null, 0);
      ...
      CKEDITOR.plugins.link = {
        ...
        parseLinkAttributes: function(a, b) {
          ...
          if (!v.type)
            if (t = c.match(h)) v.type = "anchor", v.anchor = {}, v.anchor.name = v.anchor.id = t[1];
            else if (t = c.match(m)) {
            y = c.match(k);
            c = c.match(d);
            v.type = "email";
            ...
            (v.type = "url", v.url = {}, v.url.protocol = y[1], v.url.url = y[2]);
          if (b) {
        ...
        getLinkAttributes: function(c, d) {
          ...
          if (d.advanced) {
            for (var p in w)(e = d.advanced[w[p]]) &&
              (g[p] = e);
      ...
      CKEDITOR.removeAnchorCommand.prototype = {
        exec: function(a) {
          ...
          if (b && (d = b.getSelectedElement()) &&
            (d.getChildCount() ? d.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(a, d))) d.remove(1);
    ...
    function() {
      ...
      function d(a) {
        ...
        B(c, {
          ...
          place: function() {
            ...
            d.is(R) || m(k.top, b.scroll.y - 15, b.scroll.y + 5) ? (k.top = a.inInlineMode ? 0 : b.scroll.y, this.look(R)) : d.is(L) || m(k.top, b.pane.bottom - 5, b.pane.bottom + 15) ? (k.top = a.inInlineMode ?
              b.editable.height + b.editable.padding.top + b.editable.padding.bottom : b.pane.bottom - 1, this.look(L)) : (a.inInlineMode && (k.top -= b.editable.top + b.editable.border.top), this.look(U));
          ...
          exec: function() {
            function d(b) {
              var e = E.ie && 9 > E.version ? " " : ca,
                f = a.hotNode && a.hotNode.getText() ==
                e && a.element.equals(a.hotNode) && a.lastCmdDirection === !!c;
              h(a, function(d) {
      ...
      function x(a) {
        ...
        t(a, b);
        return !h && 0 <= b.size.top && m(c.y, 0, b.size.top + e) ? (a = a.inInlineMode || 0 === d.scroll.y ? R : U, new f([null, b, J, N, a])) : h && b.size.bottom <= d.pane.height &&
          m(c.y, b.size.bottom - e, d.pane.height) ? (a = a.inInlineMode || m(b.size.bottom, d.pane.height - e, d.pane.height) ? L : U, new f([b, null, D, N, a])) : null
      }
      ...
      function r(a) {
        ...
        var g = Math.min(g, 0 | h.size.outerHeight / 2),
          k = [],
          l, v;
        if (m(c.y, h.size.top - 1, h.size.top + g)) v = !1;
        else if (m(c.y, h.size.bottom - g, h.size.bottom + 1)) v = !0;
        else return null;
      ...
      function A(a, b, c, d) {
        for (var e = b.getDocumentPosition(),
            f = {}, g = {}, h = {}, k = {}, l = aa.length; l--;) f[aa[l]] = parseInt(b.getComputedStyle.call(b, "border-" + aa[l] + "-width"), 10) || 0, h[aa[l]] = parseInt(b.getComputedStyle.call(b, "padding-" + aa[l]), 10) || 0, g[aa[l]] = parseInt(b.getComputedStyle.call(b, "margin-" + aa[l]), 10) || 0;
        c && !d || v(a, d);
          ...
          a.on("contentDom",
            function() {
              ...
              k.is(F.$inline) || (m.inInlineMode && !u(k) && k.setStyles({
                  ...
                  "wysiwyg" ==
                  a.mode && (m.line.detach(), E.webkit && (m.hiddenMode = 1, clearTimeout(q), q = setTimeout(function() {
      ...
      var V = function() {
          ...
          return function(b, c, d) {
            ...
            return !h || h.type != CKEDITOR.NODE_ELEMENT || !h.$ || E.ie && 9 > E.version && !b.boundary.equals(h) && !b.boundary.contains(h) ? null :
              h
          }
        }(),
            ...
            a.addCommand("maximize", {
              ...
              exec: function() {
                ...
                if ("wysiwyg" == a.mode) {
                  ...
                  var x = a.editable().$;
                  g = !CKEDITOR.env.ie && [x.selectionStart,
                    x.selectionEnd
                  ];
                ...
                if (this.state == CKEDITOR.TRISTATE_OFF) {
                  ...
                  !CKEDITOR.env.gecko && h.getDocumentElement().setStyle("position",
                    "fixed");
                ...
                "wysiwyg" == a.mode ? g ? (CKEDITOR.env.gecko && e(a), a.getSelection().selectRanges(g), (x = a.getSelection().getStartElement()) && x.scrollIntoView(!0)) :
                  l.$.scrollTo(n.x, n.y) : (g && (x.selectionStart = g[0], x.selectionEnd = g[1]), x.scrollLeft = n[0], x.scrollTop = n[1]);
                g = n = null;
                u = this.state;
    ...
    function() {
      function a(a, b, c) {
        ...
        e ? c() : (a = CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile ||
          b + "filter/default.js"), CKEDITOR.scriptLoader.load(a, c, null, !0));
        return !e
      }
          ...
          f.on("paste", function(e) {
            ...
            if (k && (b || h) && (!1 !== f.fire("pasteFromWord", d) || b)) {
              ...
              var l = a(f, c, function() {
                if (l) f.fire("paste", m);
                // else if (!f.config.pasteFromWordPromptCleanup || b || confirm(f.lang.pastefromword.confirmCleanup)) d.dataValue =
                //   CKEDITOR.cleanWord(d.dataValue, f), f.fire("afterPasteFromWord", d), m.dataValue = d.dataValue;
                b = 0
              });
              l && e.cancel()
            }
      ...
      var a = {
        ...
        exec: function(a, b) {
          var c = a.lang,
            ...
            c = m && "string" === typeof m ? m : c.pastetext.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' +
              e.aria + '"\x3e' + e.display + "\x3c/kbd\x3e");
          a.execCommand("paste", {
            type: "text",
            notification: m ? c : !1
          })
        ...
        removeformat: {
          exec: function(a) {
            for (var f = a._.removeFormatRegex ||
                (a._.removeFormatRegex = new RegExp("^(?:" + a.config.removeFormatTags.replace(/,/g, "|") + ")$", "i")), b = a._.removeAttributes || (a._.removeAttributes = a.config.removeFormatAttributes.split(",")), c = CKEDITOR.plugins.removeformat.filter, e = a.getSelection().getRanges(), m = e.createIterator(), k = function(a) {
                  return a.type == CKEDITOR.NODE_ELEMENT
                }, d; d = m.getNextRange();) {
              ...
              var h = d.createBookmark(),
                ...
                g = h.endNode,
                n = function(b) {
                  for (var d = a.elementPath(b), e = d.elements,
                      g = 1, h;
    ...
    CKEDITOR.plugins.add("resize", {}), CKEDITOR.plugins.add("menubutton", {
      ...
      bindEvents: function(a) {
        ...
        a.on("beforeCommandExec", function(b) {
          var c = a.scayt,
            ...
            g = !1,
            k = !0;
          b.data.name in f.options.disablingCommandExec && "wysiwyg" == a.mode ? c && (f.destroy(a), a.fire("scaytButtonState", CKEDITOR.TRISTATE_DISABLED)) : "bold" !== b.data.name && "italic" !== b.data.name && "underline" !== b.data.name && "strike" !== b.data.name &&
            "subscript" !== b.data.name && "superscript" !== b.data.name && "enter" !== b.data.name && "cut" !== b.data.name && "language" !== b.data.name || !c || ("cut" === b.data.name && (k = !1, g = !0), "language" === b.data.name && (g = e = !0), a.fire("reloadMarkupScayt", {
              removeOptions: {
                removeInside: k,
                forceBookmark: g,
                language: e
        ...
        a.on("setData", function() {
          c();
          (a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE || a.plugins.divarea) &&
          k()
        }, this, null, 50);
        ...
        a.on("insertHtml", function() {
          a.scayt &&
            a.scayt.setFocused && a.scayt.setFocused(!0);
          a.fire("reloadMarkupScayt")
        }, this, null, 50);
        ...
        if (0 < f.length && "no_any_suggestions" !== f[0])
          if (b)
            for (b = 0; b < f.length; b++) {
              ...
              a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b],
                m, k));
              ...
              for (b = 0; b < f.length; b++) h = "grayt_suggest_" +
                CKEDITOR.plugins.scayt.suggestions[b].replace(" ", "_"), a.addCommand(h, this.createCommand(CKEDITOR.plugins.scayt.suggestions[b], m, k)), a.addMenuItem(h, {
                  label: f[b],
                  command: h,
                  group: "grayt_suggest",
                  order: b + 1
      ...
      menuGenerator: function(a,
        ...
        d ? (c = c.scayt, e = f.getAttribute(b.getScaytNodeAttributeName()), b.fire("getSuggestionsList", {
          lang: k,
          word: e
        }), e = this.buildSuggestionMenuItems(a, CKEDITOR.plugins.scayt.suggestions, d)) : h && (c = c.grayt, e = f.getAttribute(b.getGraytNodeAttributeName()), l = b.getProblemDescriptionText(e, k), c.grayt_problemdescription && l && (c.grayt_problemdescription.label =
        ...
        for (var g in c) d && -1 == CKEDITOR.tools.indexOf(m, g.replace("scayt_", "")) && "all" != a.config.scayt_contextCommands || h && "grayt_problemdescription" !== g && -1 == CKEDITOR.tools.indexOf(m, g.replace("grayt_", "")) && "all" != a.config.scayt_contextCommands || (e[g] = "undefined" != typeof c[g].state ? c[g].state : CKEDITOR.TRISTATE_OFF, "function" !==
          typeof c[g].verification || c[g].verification(a) || delete e[g], a.addCommand(g, {
            exec: c[g].exec
          }), a.addMenuItem(g, {
      ...
      createScayt: function(a) {
        ...
        this.loadScaytLibrary(a, function(a) {
          ...
          if (m) {
            ...
            "boolean" ===
            typeof a.config.scayt_ignoreWordsWithMixedCases && (m["ignore-words-with-mixed-cases"] = a.config.scayt_ignoreWordsWithMixedCases);
      ...
      CKEDITOR.plugins.add("stylescombo", {
        ...
        init: function(a) {
          ...
          a.on("stylesSet", function(b) {
            if (b = b.data.styles) {
              for (var d, h, l, g = 0, n = b.length; g < n; g++)(d = b[g], a.blockless && d.element in CKEDITOR.dtd.$block || "string" == typeof d.type && !CKEDITOR.style.customHandlers[d.type] || (h = d.name, d = new CKEDITOR.style(d), a.filter.customConfig && !a.filter.check(d))) || (d._name = h, d._.enterMode = f.enterMode, d._.type = l = d.assignedTo || d.type, d._.weight =
                g + 1E3 * (l == CKEDITOR.STYLE_OBJECT ? 1 : l == CKEDITOR.STYLE_BLOCK ? 2 : 3), c[h] = d, e.push(d), m.push(d));
              e.sort(function(a, b) {
          ...
          a.ui.addRichCombo("Styles", {
            ...
            init: function() {
              var a, c, f, l, g, m;
              g = 0;
              for (m = e.length; g < m; g++) a = e[g], c = a._name, l = a._.type, l != f && (this.startGroup(b["panelTitle" + String(l)]),
    ...
    }(), CKEDITOR.dom.element.prototype.focusNext = function(a, f) {}, CKEDITOR.dom.element.prototype.focusPrevious = function(a, f) {
                ...
                right: function(a) {
                  if (a.styles) {
                    ...
                    if (a.styles.border) b = CKEDITOR.tools.style.parse.border(a.styles.border);
                      ...
                      var f = a.styles;
                      f["border-left"] && f["border-left"] === f["border-right"] && f["border-right"] === f["border-top"] &&
    ...
    function() {
      ...
      function f(b, c) {
        for (var d = w(b) ? b : a(b), e = d[0], f = e.getAscendant("table"), e = e.getDocument(), g = d[0].getParent(), h = g.$.rowIndex, d = d[d.length - 1], k = d.getParent().$.rowIndex + d.$.rowSpan - 1, d = new CKEDITOR.dom.element(f.$.rows[k]), h = c ? h : k, g = c ? g : d, d = CKEDITOR.tools.buildTableMap(f), f = d[h], h = c ? d[h - 1] : d[h + 1], d = d[0].length, e = e.createElement("tr"), k = 0; f[k] && k < d; k++) {
          var l;
          1 < f[k].rowSpan && h && f[k] == h[k] ? (l = f[k], l.rowSpan += 1) : (l = (new CKEDITOR.dom.element(f[k])).clone(), l.removeAttribute("rowSpan"), l.appendBogus(), e.append(l),
            l = l.$);
          k += l.colSpan - 1
        }
          ...
          for (c = h; c <= k; c++) {
            for (var l = g[c], m = new CKEDITOR.dom.element(f.$.rows[c]), n = 0; n < l.length; n++) {
              ...
              1 == p.$.rowSpan ? p.remove() : (--p.$.rowSpan,
                u == c && (u = g[c + 1], u[n - 1] ? p.insertAfter(new CKEDITOR.dom.element(u[n - 1])) : (new CKEDITOR.dom.element(f.$.rows[c + 1])).append(p, 1)));
              n += p.$.colSpan - 1
            }
            e.push(m)
          }
      ...
      function c(a, b) {
        for (var c =
            a.getParent().$.cells, d = 0, e = 0; e < c.length; e++) {
          var f = c[e],
            d = d + (b ? 1 : f.colSpan);
          if (f == a.$) break
        }
      ...
      function m(b, c) {
        ...
        for (m = 0; m < l; m++) f[m] && (1 < f[m].colSpan && g[m] == f[m] ? (k = f[m], k.colSpan += 1) : (h = new CKEDITOR.dom.element(f[m]),
      ...
      function k(b) {
        ...
        for (b = h.length; n < b; n++)
          for (var p = 0, u = h[n].length; p < u; p++) void 0 === k && h[n][p] == f.$ && (k = p), h[n][p] == g.$ && (l = p);
        for (n = k; n <= l; n++)
      ...
      function n(b, c, d) {
        ...
        for (c = 0; c < e.length; c++) {
          ...
          var Q = h.getParent(),
            ...
            w = Math.max(w, U - p + R);
          u = Math.max(u, Q - n + L);
          d || (R = h, (L = R.getBogus()) && L.remove(),
            R.trim(), h.getChildren().count() && (Q == K || !N || N.isBlockBoundary && N.isBlockBoundary({
              br: 1
      ...
      function p(b, c) {
        ...
        if (1 < m) {
          ...
          for (m = n = 1, f = e.clone(), f.insertAfter(e), f.append(e = d.clone()),
            p = g(h, k), l = 0; l < p.length; l++) p[l].rowSpan++;
        e.appendBogus();
        d.$.rowSpan = n;
        e.$.rowSpan = m;
    ...
    function() {
      function a(a, b) {
        ...
        m > n && (c = m, m = n, n = c);
        for (c = f; c <= g; c++)
          for (f = m; f <= n; f++) d = new CKEDITOR.dom.element(e[c][f]), d.$ && !d.getCustomData("selected_cell") && (k.push(d), CKEDITOR.dom.element.setMarker(l, d, "selected_cell", !0));
      ...
      function k(b, d, f) {
        ...
        if (h) w.first = d || g[0], w.dirty = d ? !1 : 1 !== g.length;
        else if (w.active && d && w.first.getAscendant("table").equals(d.getAscendant("table"))) {
          g =
            a(w.first, d);
      ...
      function l(a) {
        ...
        if (a.data.getTarget().getName) {
          ...
          "mouseup" === a.name && (CKEDITOR.tools.getMouseButton(a) ===
            CKEDITOR.MOUSE_BUTTON_LEFT && (e(a.data.getTarget()) || d(n, p)) && m(g), w = {
              active: !1
      ...
      function n(a, b) {
        ...
        f.getById("cke_table_copybin") || (m = f.createElement(l), n = f.createElement(l), n.setAttributes({
          ...
          height: "1px",
          overflow: "hidden"
        }), m.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), m.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), n.append(m), a.editable().append(n), q = a.on("selectionChange", c, null, null, 0), k && (p = h.scrollTop), g.selectNodeContents(m), g.select(), k && (h.scrollTop =
      ...
      u.prototype.insertRow = function(a, b, c) {
        ...
        for (var d = this.cells.first.$.cellIndex,
            e = this.cells.last.$.cellIndex, f = c ? [] : this.cells.all, g, h = 0; h < a; h++) g = A(c ? this.cells.all : f, b), g = CKEDITOR.tools.array.filter(g.find("td, th").toArray(), function(a) {
      ...
      var y = {
        onPaste: function(b) {
          ...
          !k.length || 1 === k.length && !f(h.getRanges()[0]) && !m || m && !l || (k = k[0].getAscendant("table"), n = new u(x(h, k)), g.once("afterPaste", function() {
            ...
            e(g, b)
          }), l ? (b.stop(), m ? (n.insertRow(1, 1 === m, !0), h.selectElement(n.rows.first)) : (n.emptyCells(), e(g, n.cells.all)), b = n.getTableMap(), p = CKEDITOR.tools.buildTableMap(l),
        ...
        pasteTable: function(a, b, c) {
          var d, e = r(a.cells.first, !0),
            f = a._getTable(),
            g = {},
            h, k, l, m;
          for (l = 0; l < c.length; l++)
            for (h = new CKEDITOR.dom.element(f.$.rows[a.rows.first.$.rowIndex + l]), m = 0; m < c[l].length; m++)
              if (k = new CKEDITOR.dom.element(c[l][m]), d = b[l] &&
                b[l][m] ? new CKEDITOR.dom.element(b[l][m]) : null, k && !k.getCustomData("processed")) {
                if (d && d.getParent()) k.replace(d);
                else if (0 === m || c[l][m - 1])(d = 0 !== m ? new CKEDITOR.dom.element(c[l][m - 1]) : null) && h.equals(d.getParent()) ? k.insertAfter(d) : 0 < e ? h.$.cells[e] ? k.insertAfter(new CKEDITOR.dom.element(h.$.cells[e])) : h.append(k) : h.append(k, !0);
      ...
      CKEDITOR.plugins.add("tableselection", {
        ...
        init: function(a) {
          CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss && a.addContentsCss(this.path + "styles/tableselection.css"), a.on("contentDom", function() {
            ...
            b.attachListener(c, "mousedown", l, null,
              e);
          ...
          }), a.on("paste", y.onPaste, y), C(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function(a,
            b) {
            e(a, b.selectedCells)
          ...
          setData: function(a, c) {
            ...
            if (c) this.setHtml(a), this.fixInitialSelection(), f.fire("dataReady");
              ...
              h ? (/<body[\s|>]/.test(a) || (a = "\x3cbody\x3e" + a), /<html[\s|>]/.test(a) || (a = "\x3chtml\x3e" + a + "\x3c/html\x3e"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$\x26\x3ctitle\x3e\x3c/title\x3e")) : a = a.replace(/<html[^>]*>/, "$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"),
                n && (a = a.replace(/<head[^>]*?>/, "$\x26" + n)), a = a.replace(/<\/head\s*>/, g + "$\x26"), a = l + a) : a = d.docType + '\x3chtml dir\x3d"' + d.contentsLangDirection + '" lang\x3d"' + (d.contentsLanguage || f.langCode) + '"\x3e\x3chead\x3e\x3ctitle\x3e' + this._.docTitle + "\x3c/title\x3e" + n + g + "\x3c/head\x3e\x3cbody" + (d.bodyId ? ' id\x3d"' + d.bodyId + '"' : "") + (d.bodyClass ? ' class\x3d"' + d.bodyClass + '"' : "") + "\x3e" + a + "\x3c/body\x3e\x3c/html\x3e";
    ...
    }(), CKEDITOR.config.disableObjectResizing = !1, CKEDITOR.config.disableNativeTableHandles = !0, CKEDITOR.config.disableNativeSpellChecker = !0, CKEDITOR.config.plugins = "dialogui,dialog,about,basicstyles,blockquote,notification,button,toolbar,clipboard,panel,floatpanel,menu,contextmenu,elementspath,indent,indentlist,list,enterkey,entities,popup,filebrowser,floatingspace,listblock,richcombo,format,horizontalrule,htmlwriter,image,fakeobjects,link,maximize,pastefromword,pastetext,removeformat,resize,menubutton,scayt,showborders,sourcearea,stylescombo,tab,table,tableselection,undo,wsc,wysiwygarea",
